...
public interface BoardDAOService {
	...
	ArrayList<BoardVO> findByWriterBoard(String writer); // 6. 글검색 by 작성자
	void updateBoard(int bno, String subject, String writer, String content);
